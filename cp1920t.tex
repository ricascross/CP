...
\\
\>[B]{}\Varid{discollect}\mathrel{=}\Varid{cataList}\;\alt{\Varid{nil}}{\uncurry{(\plus )}\comp (\Varid{dic}\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic}\mathbin{::}(\Conid{Ord}\;\Varid{b},\Conid{Ord}\;\Varid{a})\Rightarrow (\Varid{b},[\mskip1.5mu \Varid{a}\mskip1.5mu])\to [\mskip1.5mu (\Varid{b},\Varid{a})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{dic}\;(\Varid{h},\Varid{l})\mathrel{=}\Varid{set}\;[\mskip1.5mu \Varid{h}\mapsto\Varid{x}\mid \Varid{x}\leftarrow \Varid{l}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g1}\mathrel{=}\Varid{singl}\comp \conj{\Varid{nil}}{\Varid{id}}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g2}\;(\Varid{o},\Varid{l})\mathrel{=}{}\<[17]%
\>[17]{}(\map \;((\Varid{o}\plus )\times\Varid{id})\comp \Varid{concat})\;\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\begin{eqnarray*}
\xymatrix{
    \ensuremath{\Conid{Exp}\;\Varid{c}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]}
           \ar[d]_-{\ensuremath{\Varid{tar}}}
&
    \ensuremath{\mathit C\mathbin{+}{\Conid{A}}^{*}\times{(\Conid{Exp}\;\Varid{c}\;[\mskip1.5mu \Varid{a}\mskip1.5mu])}^{*}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{cataExp}\;\Varid{tar})}}
           \ar[l]_-{\ensuremath{\Varid{inLTree}}}
\\
     \ensuremath{({\Conid{A}}^{*}\times\Varid{c})}
&
     \ensuremath{\mathit C\mathbin{+}{\Conid{A}}^{*}\times{({({\Conid{A}}^{*}\times\Varid{c})}^{*})}^{*}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dic\char95 rd}\;\Varid{s}\mathrel{=}\Varid{lookup}\;\Varid{s}\comp \Varid{dic\char95 exp}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 in}\;\Varid{a}\;\Varid{b}\;\Varid{c}\mathrel{=}\Varid{dic\char95 imp}\;(\Varid{collect}\;((\plus )\;(\Varid{singl}\;\conj{\p1}{\p2}\;((\mapsto)\;\Varid{a}\;\Varid{b}))\;(\Varid{discollect}\;(\Varid{dic\char95 exp}\;(\Varid{c}))))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Conid{Como}\;\Varid{não}\;\Varid{conseguimos}\;\Varid{usar}\;\Varid{hilomorfismos}\;\Varid{para}\;\Varid{definir}\;\Varid{estas}\;\Varid{funções}\;(\Varid{dic\char95 rd}\;\Varid{e}\;\Varid{dic\char95 imp}),{}\<[E]%
\\
\>[B]{}\Varid{optamos}\;\Varid{por}\;\Varid{exportar}\;\Varid{o}\;\Varid{dicionário}\;\Varid{para}\;\Varid{listas}\;\Varid{e}\;\Varid{trabalhar}\;\Varid{sobre}\;\Varid{listas}\comp {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{comparaMin}\comp (\Varid{id}\times\Varid{swap})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{maisEsq}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{comparaMin}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{comparaMin}\mathbin{::}(\Varid{a},(\Conid{Maybe}\;\Varid{a},\Conid{Maybe}\;\Varid{a}))\to \Conid{Maybe}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{comparaMin}\;(\Varid{r},(\Varid{e},\Varid{d})){}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mid (\Varid{isNothing}\;\Varid{e})\mathrel{=}\Conid{Just}\;\Varid{r}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mid \Varid{otherwise}\mathrel{=}\Varid{e}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{rrot}\;(\Conid{Node}\;(\Varid{r},(\Conid{Empty},\Varid{d})))\mathrel{=}\Conid{Node}\;(\Varid{r},(\Conid{Empty},\Varid{d})){}\<[E]%
\\
\>[B]{}\Varid{rrot}\;(\Conid{Node}\;(\Varid{c},(\Conid{Node}\;(\Varid{e},(\Varid{ee},\Varid{ed})),\Varid{r})))\mathrel{=}\Conid{Node}\;(\Varid{e},(\Varid{ee},\Conid{Node}\;(\Varid{c},(\Varid{ed},\Varid{r})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lrot}\mathrel{=}\Varid{invBTree}\comp \Varid{rrot}\comp \Varid{invBTree}{}\<[E]%
\\[\blanklineskip]%
...
\begin{eqnarray*}
\start
\ensuremath{\begin{lcbr}\Varid{extLTree}\;(\Conid{Dec}\;\Varid{a})\mathrel{=}\Conid{Leaf}\;\Varid{a}\\\Varid{extLTree}\;(\Conid{Query}\;(\Varid{s},(\Varid{e},\Varid{d}))\mathrel{=}\Conid{Fork}\;(\Varid{extLTree}\;\Varid{e},\Varid{extLTree}\;\Varid{d})\end{lcbr}}
%
\just\equiv{Def-proj}
%
\ensuremath{\begin{lcbr}\Varid{extLTree}\;(\Conid{Dec}\;\Varid{a})\mathrel{=}\Conid{Leaf}\;\Varid{a}\\\Varid{extLTree}\;(\Conid{Query}\;(\Varid{s},(\Varid{e},\Varid{d}))\mathrel{=}\Conid{Fork}\comp \p2\;(\Varid{s},(\Varid{extLTree}\;\Varid{e},\Varid{extLTree}\;\Varid{d}))\end{lcbr}}
%
\just\equiv{Def-x , Natural-id}
%
\ensuremath{\begin{lcbr}\Varid{extLTree}\;(\Conid{Dec}\;\Varid{a})\mathrel{=}\Conid{Leaf}\;\Varid{a}\\\Varid{extLTree}\;(\Conid{Query}\;(\Varid{s},(\Varid{e},\Varid{d})))\mathrel{=}\Conid{Fork}\comp \p2\comp (\Varid{id}\times(\Varid{extLTree}\times\Varid{extLTree}))\;(\Varid{s},(\Varid{e},\Varid{d}))\end{lcbr}}
%
\just\equiv{Igualdade extensional , Def-comp}
%
\ensuremath{\begin{lcbr}\Varid{extLTree}\comp \Conid{Dec}\mathrel{=}\Conid{Leaf}\\\Varid{extLTree}\comp \Conid{Query}\mathrel{=}\Conid{Fork}\comp \p2\comp (\Varid{id}\times(\Varid{extLTree}\times\Varid{extLTree}))\end{lcbr}}
%
\just\equiv{Eq-+ , Fusão-+}
%
\ensuremath{\Varid{extLTree}\comp \alt{\Conid{Dec}}{\Conid{Query}}\mathrel{=}\alt{\Conid{Leaf}}{\Conid{Fork}\comp \p2\comp (\Varid{id}\times(\Varid{extLTree}\times\Varid{extLTree}))}}
%
\just\equiv{Absorção-+}
%
\ensuremath{\Varid{extLTree}\comp \alt{\Conid{Dec}}{\Conid{Query}}\mathrel{=}\alt{\Conid{Leaf}}{\Conid{Fork}\comp \p2}\comp (\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{extLTree}\times\Varid{extLTree})))}
%
\just\equiv{Def. inBdt}
%
\ensuremath{\Varid{extLTree}\comp \mathbf{in}\mathrel{=}\alt{\Conid{Leaf}}{\Conid{Fork}\comp \p2}\comp (\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{extLTree}\times\Varid{extLTree})))}
%
\just\equiv{Universal-cata}
%
\ensuremath{\Varid{extLTree}\mathrel{=}\Varid{cataBdt}\;\alt{\Conid{Leaf}}{\Conid{Fork}\comp \p2}}
\end{eqnarray*}
...
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{S}\times(\Conid{Bdt}\times\Conid{Bdt})\mskip1.5mu]}
      \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{extLTree}\times\Varid{extLTree})}}
\\
     \ensuremath{\mathsf{LTree}\;\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}\Conid{S}\times(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A})}
...
\\
\>[B]{}\Varid{outBdt}\;(\Conid{Query}\;(\Varid{s},(\Varid{e},\Varid{d})))\mathrel{=}i_2\;(\Varid{s},(\Varid{e},\Varid{d})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\begin{eqnarray*}
\start
\ensuremath{\Varid{outBdt}\comp \Varid{inBdt}\mathrel{=}\Varid{id}}
%
\just\equiv{Def.inBdt , Reflexão-+}
%
\ensuremath{\Varid{outBdt}\comp \alt{\Conid{Dec}}{\Conid{Query}}\mathrel{=}\alt{i_1}{i_2}}
%
\just\equiv{Fusão-+}
%
\ensuremath{\alt{\Varid{outBdt}\comp \Conid{Dec}}{\Varid{outBdt}\comp \Conid{Query}}\mathrel{=}\alt{i_1}{i_2}}
%
\just\equiv{Eq-+}
%
\ensuremath{\begin{lcbr}\Varid{outBdt}\comp \Conid{Dec}\mathrel{=}i_1\\\Varid{outBdt}\comp \Conid{Query}\mathrel{=}i_2\end{lcbr}}
%
\just\equiv{Igualidade extensional , Def-comp}
%
\ensuremath{\begin{lcbr}\Varid{outBdt}\;(\Conid{Dec}\;\Varid{a})\mathrel{=}i_1\;(\Varid{a})\\\Varid{outBdt}\;(\Conid{Query}\;(\Varid{s},(\Varid{e},\Varid{d}))\mathrel{=}i_2\;(\Varid{s},(\Varid{e},\Varid{d})))\end{lcbr}}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\[\blanklineskip]%
\>[B]{}\Varid{anaBdt}\;{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}\Varid{inBdt}\comp (\Varid{recBdt}\;(\Varid{anaBdt}\;\Varid{g}))\comp \Varid{g}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix{
        \ensuremath{\Conid{Bdt}\;\Conid{A}}
&&
        \ensuremath{\Conid{A}\mathbin{+}\Conid{S}\times(\Conid{Bdt}\;\Conid{A}\times\Conid{Bdt}\;\Conid{A})}
                \ar[ll]_-{\ensuremath{\Varid{inBdt}}}
\\
        \ensuremath{\mathit B}
                \ar[rr]_-{\ensuremath{\Varid{g}}}
                \ar[u]^-{\ensuremath{\Varid{anaBdt}\;\Varid{g}}}
&&
        \ensuremath{\Conid{A}\mathbin{+}\Conid{S}\times(\mathit B\times\mathit B)}
...
\\
\>[B]{}\Varid{navLTree}\;\Varid{a}\;\Varid{l}\mathrel{=}\Varid{cataLTree}\;\alt{\Conid{Leaf}}{\Varid{g}\;\Varid{a}\;\Varid{l}}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{}\mathbf{where}\;\Varid{g}\;\Varid{a}\;\Varid{l}\;(\Varid{e},\Varid{d})\mathrel{=}\mathbf{let}\;\Varid{v}\mathrel{=}(\Varid{buscaLista}\;\Varid{l}\;(\Varid{umin}\;(\Varid{posArvE}\;\Varid{a}\;\Varid{e},\Varid{posArvD}\;\Varid{a}\;\Varid{d}))){}\<[E]%
\\
\>[12]{}\hsindent{19}{}\<[31]%
\>[31]{}\mathbf{in}\;\mathbf{if}\;(\Varid{v}\equiv \mathrm{0})\;\mathbf{then}\;(\Conid{Fork}\;(\Varid{e},\Varid{d}))\;\mathbf{else}\;\mathbf{if}\;(\Varid{v}\equiv \mathrm{1})\;\mathbf{then}\;\Varid{e}\;\mathbf{else}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{depth}\mathrel{=}\Varid{cataLTree}\;\alt{\underline{\mathrm{1}}}{\succ \comp \Varid{umax}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{depthE}\mathbin{::}\mathsf{LTree}\;\Varid{a}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{depthE}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{depthE}\;(\Conid{Fork}\;(\Varid{e},\Varid{d}))\mathrel{=}\mathrm{1}\mathbin{+}\Varid{depth}\;\Varid{e}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{depthD}\mathbin{::}\mathsf{LTree}\;\Varid{a}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{depthD}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{depthD}\;(\Conid{Fork}\;(\Varid{e},\Varid{d}))\mathrel{=}\mathrm{1}\mathbin{+}\Varid{depth}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{posArvE}\mathbin{::}\mathsf{LTree}\;\Varid{a}\to \mathsf{LTree}\;\Varid{a}\to \Conid{Int}\mbox{\onelinecomment  posicao da subarvore d na arvore t}{}\<[E]%
\\
\>[B]{}\Varid{posArvE}\;\Varid{t}\;\Varid{e}\mathrel{=}(\Varid{depthE}\;\Varid{t})\mathbin{-}(\Varid{depth}\;\Varid{e}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{posArvD}\mathbin{::}\mathsf{LTree}\;\Varid{a}\to \mathsf{LTree}\;\Varid{a}\to \Conid{Int}\mbox{\onelinecomment  posicao da subarvore d na arvore t}{}\<[E]%
\\
\>[B]{}\Varid{posArvD}\;\Varid{t}\;\Varid{d}\mathrel{=}(\Varid{depthD}\;\Varid{t})\mathbin{-}(\Varid{depth}\;\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{buscaLista}\mathbin{::}[\mskip1.5mu \Conid{Bool}\mskip1.5mu]\to \Conid{Int}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{buscaLista}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{n}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{buscaLista}\;(\Varid{h}\mathbin{:}\Varid{t})\;\mathrm{1}\mathrel{=}\mathbf{if}\;\Varid{h}\;\mathbf{then}\;\mathrm{1}\;\mathbf{else}\;\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{buscaLista}\;(\Varid{h}\mathbin{:}\Varid{t})\;\Varid{n}\mathrel{=}\Varid{buscaLista}\;\Varid{t}\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\;\Varid{p}\;\anonymous \mathrel{=}{}\<[19]%
\>[19]{}\Conid{Leaf}\;\Varid{p}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{a},\Varid{b})\;\Conid{Empty}\mathrel{=}\Conid{Fork}\;(\Varid{a}\;\Conid{Empty},\Varid{b}\;\Conid{Empty}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{a},\Varid{b})\;(\Conid{Node}\;(\Varid{c},(\Varid{l},\Varid{r})))\mathrel{=}\mathbf{if}\;\Varid{c}\equiv \Conid{True}\;\mathbf{then}\;\Varid{a}\;\Varid{l}\;\mathbf{else}\;\Varid{b}\;\Varid{r}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{cataLTree}\;\Varid{bnavLTree})}}
           \ar[l]_-{\ensuremath{\Varid{inLTree}}}
\\
     \ensuremath{\fun{BTree} \;\mathit B\to \mathsf{LTree}\;\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}(\fun{BTree} \;\mathit B\to \mathsf{LTree}\;\Conid{A})\times(\fun{BTree} \;\mathit B\to \mathsf{LTree}\;\Conid{A})}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\;\Varid{a}\;\anonymous \mathrel{=}\Conid{D}\;[\mskip1.5mu (\Conid{Leaf}\;\Varid{a},\mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{a},\Varid{b})\;\Conid{Empty}\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{final}\leftarrow \Varid{prod}\;(\Varid{a}\;\Conid{Empty})\;(\Varid{b}\;\Conid{Empty});(\Varid{return}\comp \Conid{Fork})\;\Varid{final}\mskip1.5mu\}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
...
\xymatrix{
    \ensuremath{\mathsf{LTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{pbnavLTree}}}
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{cataLTree}\;\Varid{pbnavLTree})}}
           \ar[l]_-{\ensuremath{\Varid{inLTree}}}
\\
     \ensuremath{\fun{BTree} \;(\Conid{D}\;\mathit B)\to \fun{Dist}\;(\mathsf{LTree}\;\Conid{A})}
&
     \ensuremath{\Conid{A}\mathbin{+}(\fun{BTree} \;(\fun{Dist}\;\mathit B)\to \fun{Dist}\;(\mathsf{LTree}\;\Conid{A}))\times(\fun{BTree} \;(\fun{Dist}\;\mathit B)\to \fun{Dist}\;(\mathsf{LTree}\;\Conid{A}))}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{mosaico}\leftarrow \Varid{randomMosaico}\;\mathrm{10}\;\mathrm{10}\;\mathrm{10}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{display}\;\Varid{janela}\;\Varid{white}\;\Varid{mosaico}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{randomMosaico}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \Conid{Int}\to \fun{IO}\;\Conid{Picture}{}\<[E]%
\\
\>[B]{}\Varid{randomMosaico}\;\mathrm{0}\;\anonymous \;\anonymous \mathrel{=}\Varid{return}\;(\Conid{Pictures}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{randomMosaico}\;\Varid{l}\;\Varid{c}\;\Varid{al}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{m}\leftarrow \Varid{randomMosaico}\;(\Varid{l}\mathbin{-}\mathrm{1})\;\Varid{c}\;\Varid{al}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{a}\leftarrow \Varid{randomLMosaico}\;\Varid{c}\;\Varid{c}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{let}\;\Varid{p}\mathrel{=}\Conid{Pictures}\;((\Varid{put}\;(\mathrm{0},\Varid{fromIntegral}\;(\mathrm{80}\mathbin{*}(\Varid{l}\mathbin{-}\Varid{al}\mathbin{-}\mathrm{1})))\;\Varid{a})\mathbin{:}[\mskip1.5mu \Varid{m}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{randomLMosaico}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \fun{IO}\;\Conid{Picture}{}\<[E]%
\\
\>[B]{}\Varid{randomLMosaico}\;\mathrm{0}\;\anonymous \mathrel{=}\Varid{return}\;(\Conid{Pictures}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{randomLMosaico}\;\Varid{c}\;\Varid{ac}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{m}\leftarrow \Varid{randomLMosaico}\;(\Varid{c}\mathbin{-}\mathrm{1})\;\Varid{ac}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{a}\leftarrow \Varid{randomTrunchet}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{let}\;\Varid{p}\mathrel{=}\Conid{Pictures}\;((\Varid{put}\;(\Varid{fromIntegral}\;(\mathrm{80}\mathbin{*}(\Varid{c}\mathbin{-}\Varid{ac}\mathbin{-}\mathrm{1})),\mathrm{0})\;\Varid{a})\mathbin{:}[\mskip1.5mu \Varid{m}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{return}\;\Varid{p}{}\<[E]%
\ColumnHook
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{randomTrunchet}\mathbin{::}\fun{IO}\;\Conid{Picture}{}\<[E]%
\\
\>[B]{}\Varid{randomTrunchet}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{rl}\leftarrow \Varid{permuta}\;[\mskip1.5mu \Varid{truchet1},\Varid{truchet2}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{let}\;\Varid{p}\mathrel{=}\Varid{rl}\mathbin{!!}\mathrm{0}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{return}\;\Varid{p}{}\<[E]%
\\[\blanklineskip]%
