...
Como não conseguimos usar hilomorfismos para definir estas funções (dic_rd e dic_imp), 
optamos por exportar o dicionário para listas e trabalhar sobre listas.
...
\begin{code}
maisDir = cataBTree g
  where g = ( either ( const Nothing ) (comparaMin.(id >< swap)) )

maisEsq = cataBTree g
  where g = ( either ( const Nothing ) comparaMin )

comparaMin :: ( a , ( Maybe a ,Maybe a)) -> Maybe a
comparaMin (r,(e,d))
              |(isNothing e) = Just r
              |otherwise = e
